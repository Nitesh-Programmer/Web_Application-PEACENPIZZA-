...
#heading{
    ...
    background: linear-gradient(to right, #f351f0, 
                    #ff6b08, #cf23cf, #eedd41); 
...
<body>
		...
		List<PlacedOrders> list=method.orderHistory(userId);
		
	
		String userName=(String)request.getAttribute("username");
	%>
	<h2 id="heading"> <%=userName %> Orders</h2>
	<%if(!(list.isEmpty())){ %>
	...
	<%}else{ %>
		...
		<div id="empty">
			<article> Oops! <span><i class="fa-regular fa-face-sad-tear 2x"></i></span> <%=userName %> didn't  ordered anything...</article>	
